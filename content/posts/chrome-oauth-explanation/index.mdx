---
title: Implementing Google OAuth Signin to Chrome Extension by using launchWebAuthflow (MV3)
date: 2022-11-21
tags:
  - Chrome Extension
  - OAuth
...
I'm currently building a Chrome Extension that requires a 'SignIn with Google' feature. While there are many ways to do this, I decided to use launchWebAuthflow supported by the official Chrome API. 
However, this too was not an easy task. Chrome Manifest Version 3 (MV3) was released only a while ago, thus there weren't many online resources I can refer to. After going through some mistakes and fixing errors, I finally
found a supposedly proper way to make launchWebAuthflow work. To help many other Chrome Extension developers who might be working on a similar project, I decided to breifly write about my experience online. 
